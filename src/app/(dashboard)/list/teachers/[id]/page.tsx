				...
				<div className="flex flex-col lg:flex-row gap-4">
					<div className="bg-opSky py-6 px-4 rounded-md flex gap-4 flex-1">
						...
						<div className="w-2/3 flex flex-col justify-between gap-4">
							<h1 className="text-xl font-semibold">Lorne Marvo</h1>
			...
			<div className="w-full xl:w-1/3 space-y-4">
				<div className="bg-white p-4 rounded-md">
					...
					<div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
						<Link href="/" className="p-3 rounded-md bg-opSkyLight">
							Teacher&apos;s Classes
						</Link>
						<Link href="/" className="p-3 rounded-md bg-opPurpleLight">
							Teacher&apos;s Students
						</Link>
						<Link href="/" className="p-3 rounded-md bg-opYellowLight">
							Teacher&apos;s Lessons
						</Link>
